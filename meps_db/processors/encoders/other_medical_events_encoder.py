...
class OtherMedicalExpensesEncoder(BaseEncoder):
    ...
    def __init__(self, year, dupersids=None):
        ...
        self.OM_LOOKUPS = {
            2018: {"model": OtherMedicalExpenses18, "fields": {"DUPERSID", "EVNTIDX"},},
            2017: {"model": OtherMedicalExpenses17, "fields": {"DUPERSID", "EVNTIDX"},},
            2016: {"model": OtherMedicalExpenses16, "fields": {"DUPERSID", "EVNTIDX"},},
            2015: {"model": OtherMedicalExpenses15, "fields": {"DUPERSID", "EVNTIDX"},},
            2014: {"model": OtherMedicalExpenses14, "fields": {"DUPERSID", "EVNTIDX"},},
            2013: {"model": OtherMedicalExpenses13, "fields": {"DUPERSID", "EVNTIDX"},},
            2012: {"model": OtherMedicalExpenses12, "fields": {"DUPERSID", "EVNTIDX"},},
            2011: {"model": OtherMedicalExpenses11, "fields": {"DUPERSID", "EVNTIDX"},},
            2010: {"model": OtherMedicalExpenses10, "fields": {"DUPERSID", "EVNTIDX"},},
            2009: {"model": OtherMedicalExpenses09, "fields": {"DUPERSID", "EVNTIDX"},},
            2008: {"model": OtherMedicalExpenses08, "fields": {"DUPERSID", "EVNTIDX"},},
            2007: {"model": OtherMedicalExpenses07, "fields": {"DUPERSID", "EVNTIDX"},},
            2006: {"model": OtherMedicalExpenses06, "fields": {"DUPERSID", "EVNTIDX"},},
            2005: {"model": OtherMedicalExpenses05, "fields": {"DUPERSID", "EVNTIDX"},},
        }
    ...
    def run(self):
        ...
        if self.dupersids:
            events = list(
                self.OM_LOOKUPS[self.year]["model"]
                .objects.filter(DUPERSID__in=self.dupersids)
                .values(*self.OM_LOOKUPS[self.year]["fields"])
            )
        else:
            events = list(
